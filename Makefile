...
server:
	$(CC) $(CFLAGS) -o server $(SERVER_DIR)/server.c $(SERVER_DIR)/account.c $(SERVER_DIR)/location.c $(SERVER_DIR)/friend_request.c $(SERVER_DIR)/friend.c $(SERVER_DIR)/favorite.c $(SERVER_DIR)/shared_location.c
