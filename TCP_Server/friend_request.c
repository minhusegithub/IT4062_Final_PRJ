...
void handle_send_friend_request(int client_index, char *args)
{
    ...
    {
        char log_msg[200];
        snprintf(log_msg, sizeof(log_msg), "Sent request to: %s", username);
        log_activity(client_index, "SEND_REQUEST", log_msg);
...
void handle_accept_friend_request(int client_index, char *args)
{
    ...
    char log_msg[100];
    snprintf(log_msg, sizeof(log_msg), "Accepted UserID: %d", friend_user_id);
    log_activity(client_index, "ACCEPT_REQUEST", log_msg);
...
void handle_reject_friend_request(int client_index, char *args)
{
    ...
    char log_msg[100];
    snprintf(log_msg, sizeof(log_msg), "Rejected UserID: %d", friend_user_id);
    log_activity(client_index, "REJECT_REQUEST", log_msg);
